...
from .twowheeledrobot_marl_env_cfg import TwowheeledrobotMarlEnvCfg


class TwowheeledrobotMarlEnv(DirectMARLEnv):
    cfg: TwowheeledrobotMarlEnvCfg

    def __init__(self, cfg: TwowheeledrobotMarlEnvCfg, render_mode: str | None = None, **kwargs):
